export const loggerStrings = {
  setup: "Resend integration setup...",
  ...
  updateConfig: "Updating Astro config with Resend environment variables...",
  virtualImports: "Adding Virtual Import modules...",
  setupComplete: "Resend integration setup complete.",
  injectTypes: "Injecting Resend types...",
};
